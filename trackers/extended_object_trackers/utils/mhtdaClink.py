...
# If run on Linux environment, change murty.dll to murty.so
# If run on Windows environment, change murty.so to murty.dll
dll_path = os.path.join(os.path.abspath(os.path.dirname(__file__)), "murty.so")
lib = CDLL(dll_path)
